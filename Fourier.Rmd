...
```{r }
AccidentQuarter <- c(0.25, 0.25, 0.25, 0.25, 0, 0, 0, 0)
AccidentYear <- c(0, 0.4, 0.4, 0.2, 0, 0, 0, 0)
AccidentYear <- fft(fft(AccidentYear) * fft(AccidentQuarter), inverse = TRUE) %>% Re()
